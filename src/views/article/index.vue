<template>
  <div class="container-article">
    ...
    <el-card>
      ...
      <!-- 分页 -->
      <!-- layout="prev, pager, next" 当前分页组件包含的布局 -->
      <!-- total 总条数 -->
      <!-- 默认显示10条 -->
...
export default {
  ...
  methods: {
    ...
    changeDate (dateArr) {
      ...
      // 我们需要的:dateArr是数组[string,string] string==='2019-11-01'
      // value-form="yyyy-MM-dd"格式转换成功
      // 注意:清空日期之后,dateArr是null 对应begin end 值也该为null
      if (dateArr) {
    ...
    // 删除
    async delArticle (id) {
      // 发请求 restfull 接口规则(get post put delete)
